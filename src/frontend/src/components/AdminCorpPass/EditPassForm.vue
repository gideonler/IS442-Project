<template>
  <card>
    ...
    <form enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <base-input type="text" class="mb-0" label="Attraction Name" placeholder="eg. Singapore Gardens"
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <b-input-group prepend="$">
            <b-form-input type="number" min="0" v-model="replacementfee"></b-form-input>
          </b-input-group>
        </div>
        <div class="col-md-6">
          <label>Pass Type</label>
          <b-form-radio-group id="radio-group-1" v-model="selected_passtype" :options="options" name="radio-options">
          </b-form-radio-group>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <b-form-file enctype="multipart/form-data" v-model="image" accept=".jpg, .jpeg, .png" :state="Boolean(image)"
            placeholder="Upload Photo Here..." drop-placeholder="Drop file here..."></b-form-file>
        </div>
      </div>
